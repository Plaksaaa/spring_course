...
import static com.plaxa.spring_course.entity.Role.ADMIN;
...
//                .httpBasic(Customizer.withDefaults());
                ...
                .oauth2Login(config -> config
                        .loginPage("/login")
                        .defaultSuccessUrl("/users")
                        .userInfoEndpoint(userInfo -> userInfo.oidcUserService(oidcUserOAuth2UserService()))
                );
    }
    ...
    private OAuth2UserService<OidcUserRequest, OidcUser> oidcUserOAuth2UserService() {
        return userRequest -> {
            ...
            // TODO: 28.05.22 add registration
